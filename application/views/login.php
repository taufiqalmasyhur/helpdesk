...
<html lang="en">
  ...
  <body>
    <div class="login-box">
            ...
            <p class="text-center muted text-footer">Information Technology - PT Angkasa Pura II (Persero) &copy; 2017</p>
    </div><!-- /.login-box -->
